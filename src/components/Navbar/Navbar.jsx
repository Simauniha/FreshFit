    ...
    return (
        <>
            <div className="flex items-center justify-between py-5 font-medium">
                ...
                <ul className="hidden sm:flex gap-5 gap-5 text-lg text-gray-700">
                ...
                <div className='flex items-center gap-6'>
                    ...
                    <p className='absolute right-[-7px] bottom-[-2px] w-4 text-center leading-4 bg-white text-black aspect-square border border-black rounded-full text-[10px] '>10</p>
                    </Link>
                </div>
